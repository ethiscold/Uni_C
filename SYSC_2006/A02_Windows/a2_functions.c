...
void print_menu()
{
    ...
    printf("2. Manage a user's profile (change the password)\n");
    printf("3. Manage a user's posts (display or add or remove)\n");
    printf("4. Manage a user's friends (display or add or remove)\n");
